...
struct  HtmlElementType_t2242385881 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HtmlElementType_t2242385881, ___value___1)); }
